...
// Main entry point for unauthenticated users, showcasing the app's value proposition
const LandingPage = () => {
    usePageTitle("Home");
    ...
    // Renders the marketing landing page including Hero, Features, Steps, and Testimonials sections
    return (
        <React.Fragment>
            {/* Hero Section */}
