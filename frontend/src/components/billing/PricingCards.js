...
// Reusable component displaying the pricing tiers (Free, Pro, Enterprise) across the app
const PricingCards = ({ onUpgradeClick, isUpgrading = false, isLandingPage = false }) => {
    ...
    // Initializes currency selection based on saved preference, redirect parameters, or locale defaults
    ...
    // Toggles between monthly and yearly billing cycles
    const toggleBilling = () => {
