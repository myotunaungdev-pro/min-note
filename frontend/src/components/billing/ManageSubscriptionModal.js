...
// Modal component that allows Pro users to cancel, resume, or view their subscription status
const ManageSubscriptionModal = ({ isOpen, onClose }) => {
    ...
    // Submits the cancellation request to Stripe via the backend (immediate or at period end)
    ...
    // Reactivates a subscription that was scheduled to be canceled at period end
