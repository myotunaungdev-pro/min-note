...
// The main navigation sidebar handling route changes, folder views, and displaying user profile info
const Sidebar = () => {
    ...
    // Detects screen resizing to automatically collapse the sidebar on mobile devices
    useEffect(() => {
    ...
    // Initializes the mouse dragging state for manually resizing the sidebar width
    const startResizing = (e) => {
        setIsResizing(true);
        e.preventDefault();
    };

    // Listens to global mouse events to calculate and apply the new sidebar width during resize
    useEffect(() => {
